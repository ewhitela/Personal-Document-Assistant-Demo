...
class RAGPipeline:
    ...
    SYSTEM_PROMPT = (
        ...
        "like a reasonable assumption or is common knowledge. If the passages describe "
        "something only as of a past date, or do not state its current status, "
        "do not comment on its current status.\n\n"
